...
export class ProductsAdminService {
  ...
  batchProductReviewsCleanup(productId: string): { productId: string; updated: number; note: string } {
    return { productId, updated: 0, note: 'Deferred: integrate review service.' };
  }
}
